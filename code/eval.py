...
def main():
    ...
    class_model = VisualModel(input_shape, classes, all_labels).load_from_checkpoint("wandb/run-20211010_072731-TwinsSVT_weighted/files/mediaeval21_visualsentiment/TwinsSVT_weighted/checkpoints/epoch=66-step=8173.ckpt")
    # class_model.freeze()
    bar = LitProgressBar()
